...
INSERT INTO `commentaire` (`idCommentaire`, `dateCommentaire`, `contenu`, `idArticle`, `idUtilisateur`) VALUES
(1, '2014-11-10 05:06:47', 'Mangifique', 1, 4),
(2, '2014-11-04 04:47:35', 'Très joli', 1, NULL),
(3, '2014-11-14 06:34:30', 'J''ai pas tout compris...', 2, NULL),
(4, '2014-11-05 23:07:52', 'Quel joli texte, j''adore !', 2, 2),
(5, '2014-11-26 05:42:04', 'C''est gai tout ça...', 3, NULL),
(6, '2014-11-23 07:44:33', 'Tellement beau, on ne s''en lasse pas.', 4, 1),
(7, '2014-11-22 12:05:34', 'Incroyable !!!', 5, 1),
(8, '2014-11-24 08:47:15', 'Pas mal, j''aime bien', 5, 2),
(9, '2014-11-15 21:56:05', 'Exceptionnel, mais un peu triste quand même...', 8, 1),
(10, '2014-11-09 09:09:09', 'Mouais, pas convaincue...', 5, NULL);
...
ALTER TABLE `categorie_article`
  ...
  ADD KEY `FK_categorie_article_idCategorie` (`idCategorie`);
...
--
ALTER TABLE `categorie_article`
  ADD CONSTRAINT `FK_categorie_article_idArticle` FOREIGN KEY (`idArticle`) REFERENCES `article` (`idArticle`),
  ADD CONSTRAINT `FK_categorie_article_idCategorie` FOREIGN KEY (`idCategorie`) REFERENCES `categorie` (`idCategorie`);
